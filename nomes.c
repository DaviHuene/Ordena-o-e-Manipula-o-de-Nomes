...
int main() {
    ...
    while (running) {
        ...
        if (choice == 1) {
            ...
            switch (file_choice) {
                case 1:
                    addNameKeepingOrder("output/nomes_aleatorio.txt", 3); // Aleatório
                    break;
                case 2:
                    addNameKeepingOrder("output/nomes_crescente.txt", 1); // Crescente
                    break;
                case 3:
                    addNameKeepingOrder("output/nomes_decrescente.txt", 2); // Decrescente
                    break;
                default:
